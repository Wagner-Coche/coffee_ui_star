  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: const [
          CardCoffeeWidget(image: "assets/images/pexels-ryan-horn-2318017.jpg", points: 4.5,),
          CardCoffeeWidget(image: "assets/images/pexels-georgie-devlin-8631270.jpg", points: 3.1)
        ],
      ),
    );
  }
